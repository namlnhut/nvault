...
\[
\nabla^2 f(x) \succeq 0 \qquad \text{for every } x \in U.
\]
...
\[
\nabla^2 f(x) \succeq 0 \qquad \text{for every } x \in \operatorname{int}(C).
\]
...
\[
\nabla^2 f(x) \succeq 0 \qquad \text{for every } x \in C?
\]
...
\[
\inner{\nabla^2 f(x)h}{h} \geq 0 \qquad \text{for every } h \in T_C(x)?
\]
